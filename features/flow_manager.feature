...
Feature: flow_manager tests
  ...
  Given a file named "cflow_manager.conf" with:
    ...
    """
  @slow_process
  Scenario: Run "flow_manager path setup multiple controller with one flow_manager" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_module_setup_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 3 ***
  ...
  Scenario: Run "flow_manager path setup test" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_path_setup_test.rb -c tmp/aruba/flow_manager.conf -d`
    When *** sleep 5 ***
  ...
  Scenario: Run "flow_manager_multiple_path_setup_test" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_multiple_path_setup_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 30 ***
    Then the file "tmp/log/FlowManagerController.log" should contain "**** Path setup completed ( status = succeeded)***"
    Then the file "tmp/log/FlowManagerController.log" should contain "***Path teardown completed ( reason = timeout)***"
  ...
  Scenario: Run "flow_manager path setup duplicate" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_path_setup_duplicate_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
  ...
  Scenario: Run "flow_manager path teardown by manual" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_path_teardown_by_manual_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
  ...
  Scenario: Run "flow_manager module teardown" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_module_teardown_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
    Then the file "tmp/log/FlowManagerController.log" should contain "**** Path setup completed ( status = succeeded)***"
  ...
  Scenario: Run "flow_manager module lookup" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_module_lookup_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
    Then the file "tmp/log/FlowManagerController.log" should contain "**** Path setup completed ( status = succeeded)***"
  ...
  Scenario: Run "flow_manager module teardown by match" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_module_teardown_by_match_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
    Then the file "tmp/log/FlowManagerController.log" should contain "**** Path setup completed ( status = succeeded)***"
    Then the file "tmp/log/FlowManagerController.log" should contain "teardown bool:true"
    Then the file "tmp/log/FlowManagerController.log" should contain "***Path teardown completed ( reason = manually requested)***"    
  ...
  Scenario: Run "flow_manager_init_finalize_test" Ruby example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run src/flow_manager/flow_manager_test/flow_manager_init_finalize_test.rb -c tmp/aruba/flow_manager_simple.conf -d`
    When *** sleep 20 ***
  ...
  Scenario: Run "flow_manager c test" C example
    Given The default aruba timeout is 60 seconds
    Given I cd to "../.."
    Given I run `trema run -c tmp/aruba/cflow_manager.conf objects/examples/flow_manager_example/flow_manager_example -d`
    When *** sleep 15 ***
