...
class PacketQueue
  ...
  # @return [String]
  #   string representation of {PacketQueue}'s attributes and all its properties 
...
class QueueProperty
  ...
  # @return [String]
  #  string representation of its attributes (property,len).
  def to_s
...
class MinRateQueue < QueueProperty
  ...
  # @return [String]
  #  string representation of rate prefixed by property and length attributes.
  def to_s
