...
module Trema
  ...
  describe FeaturesReply, ".new(options...) (No :n_buffers)" do
    subject {
      FeaturesReply.new( {
        :datapath_id => 123,
        :transaction_id => 1234,
    ...
    it { expect { subject }.to raise_error( ArgumentError, ":n_buffers is a mandatory option" ) }
  end


  describe FeaturesReply, ".new(options...) (No :n_tables)" do
    subject {
      FeaturesReply.new( {
        :datapath_id => 123,
        :transaction_id => 1234,
    ...
    it { expect { subject }.to raise_error( ArgumentError, ":n_tables is a mandatory option" ) }
  end


  describe FeaturesReply, ".new(options...) (No :capabilities)" do
    subject {
      FeaturesReply.new( {
        :datapath_id => 123,
        :transaction_id => 1234,
    ...
    it { expect { subject }.to raise_error( ArgumentError, ":capabilities is a mandatory option" ) }
  end
  ...
  describe FeaturesReply, ".new(options...) (No :capabilities)" do
    ...
    it { expect { subject }.to raise_error( ArgumentError, ":actions is a mandatory option" ) }
  end
  ...
  describe FeaturesReply, ".new(options...) (No :capabilities)" do
    ...
    it { expect { subject }.to raise_error( ArgumentError, ":ports is a mandatory option" ) }
  end
end
