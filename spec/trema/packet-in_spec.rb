    ...
    it "should have correct VLAN and ICMPv4 packet fields" do
      network {
        ...
        controller( "PacketInSendController" ).should_receive( :packet_in ) do | datapath_id, message |
          ...
          message.icmpv4_type_echo_reply.should be_false
          message.icmpv4_type_dst_unreach.should be_false
          message.icmpv4_type_redirect.should be_false
          message.icmpv4_type_echo_request.should be_true
        end
