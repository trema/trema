...
describe Trema::ActionSetDlDst do
  context "when an instance is created" do
    subject { Trema::ActionSetDlDst.new( Mac.new( "52:54:00:a8:ad:8c" ) ) }
    its( :dl_dst ) { should be_an_instance_of( Trema::Mac ) }
    it { should respond_to( :to_s ) }
    it "should print its attributes" do
      subject.to_s.should == "#<Trema::ActionSetDlDst> dl_dst = 52:54:00:a8:ad:8c"
    end
    it "should append its dl_dst to a list of actions" do
