 ...
 * @file
 *
 * @brief OpenFlow service interface declarations
 *
...
/*
 *  Message type definitions for sending/receiving OpenFlow messages or related events via messenger.
 */
...
/**
 * Header definitions for sending/receiving OpenFlow messages or events via
 * messenger. A null-terminated service name can be provided after service_name_length
 * and an OpenFlow message must be included in the rest of part in case of
 * MESSENGER_OPENFLOW_MESSAGE. service_name_length can be zero if service name
