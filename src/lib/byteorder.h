...
void ntoh_aggregate_stats( struct ofp_aggregate_stats_reply *dst,
...
void ntoh_queue_property( struct ofp_queue_prop_header *dst,
                          const struct ofp_queue_prop_header *src );
void hton_queue_property( struct ofp_queue_prop_header *dst,
                          const struct ofp_queue_prop_header *src );
void ntoh_packet_queue( struct ofp_packet_queue *dst,
                        const struct ofp_packet_queue *src);
void hton_packet_queue( struct ofp_packet_queue *dst,
                        const struct ofp_packet_queue *src);
